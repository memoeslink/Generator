...
public class Database {
    ...
    public static String selectFromTable(String table) {
        return selectRow("SELECT * FROM " + table + " ORDER BY RANDOM() LIMIT 1", 2);
    }

    public static String selectFromTable(String table, int id) {
        return selectRow("SELECT * FROM " + table + " WHERE " + table + ID_PREFIX + " = ?", 2, String.valueOf(id));
    }
    ...
    public static String selectEnglishAdjective() {
        return selectRow("SELECT * FROM " + TABLE_ENGLISH_ADJECTIVES + " ORDER BY RANDOM() LIMIT 1", 2);
    }

    public static String selectEnglishAdjective(int id) {
        return selectRow("SELECT * FROM " + TABLE_ENGLISH_ADJECTIVES + " WHERE " + TABLE_ENGLISH_ADJECTIVES + ID_PREFIX + " = ?", 2, String.valueOf(id));
    }
    ...
    public static String selectEnglishFemaleName() {
        return selectRow("SELECT * FROM " + TABLE_ENGLISH_FEMALE_NAMES + " ORDER BY RANDOM() LIMIT 1", 2);
    }

    public static String selectEnglishFemaleName(int id) {
        return selectRow("SELECT * FROM " + TABLE_ENGLISH_FEMALE_NAMES + " WHERE " + TABLE_ENGLISH_FEMALE_NAMES + ID_PREFIX + " = ?", 2, String.valueOf(id));
    }
    ...
    public static String selectEnglishMaleName() {
        return selectRow("SELECT * FROM " + TABLE_ENGLISH_MALE_NAMES + " ORDER BY RANDOM() LIMIT 1", 2);
    }

    public static String selectEnglishMaleName(int id) {
        return selectRow("SELECT * FROM " + TABLE_ENGLISH_MALE_NAMES + " WHERE " + TABLE_ENGLISH_MALE_NAMES + ID_PREFIX + " = ?", 2, String.valueOf(id));
    }
    ...
    public static String selectEnglishNoun() {
        return selectRow("SELECT * FROM " + TABLE_ENGLISH_NOUNS + " ORDER BY RANDOM() LIMIT 1", 2);
    }

    public static String selectEnglishNoun(int id) {
        return selectRow("SELECT * FROM " + TABLE_ENGLISH_NOUNS + " WHERE " + TABLE_ENGLISH_NOUNS + ID_PREFIX + " = ?", 2, String.valueOf(id));
    }
    ...
    public static String selectEnglishOccupation() {
        return selectRow("SELECT * FROM " + TABLE_ENGLISH_OCCUPATIONS + " ORDER BY RANDOM() LIMIT 1", 2);
    }

    public static String selectEnglishOccupation(int id) {
        return selectRow("SELECT * FROM " + TABLE_ENGLISH_OCCUPATIONS + " WHERE " + TABLE_ENGLISH_OCCUPATIONS + ID_PREFIX + " = ?", 2, String.valueOf(id));
    }
    ...
    public static String selectEnglishPhoneticScript() {
        return selectRow("SELECT Word, Phonetics FROM " + TABLE_ENGLISH_PHONETICS + " ORDER BY RANDOM() LIMIT 1", 2);
    }
    ...
    public static String selectEnglishSurname() {
        return selectRow("SELECT * FROM " + TABLE_ENGLISH_SURNAMES + " ORDER BY RANDOM() LIMIT 1", 2);
    }
    ...
    public static String selectCodePoints() {
        return selectRow("SELECT * FROM " + TABLE_EMOJIS + " ORDER BY RANDOM() LIMIT 1", 2);
    }

    public static String selectCodePoints(int id) {
        return selectRow("SELECT * FROM " + TABLE_EMOJIS + " WHERE " + TABLE_EMOJIS + ID_PREFIX + " = ?", 2, String.valueOf(id));
    }
    ...
    public static String selectFrenchFemaleName() {
        return selectRow("SELECT * FROM " + TABLE_FRENCH_FEMALE_NAMES + " ORDER BY RANDOM() LIMIT 1", 2);
    }

    public static String selectFrenchFemaleName(int id) {
        return selectRow("SELECT * FROM " + TABLE_FRENCH_FEMALE_NAMES + " WHERE " + TABLE_FRENCH_FEMALE_NAMES + ID_PREFIX + " = ?", 2, String.valueOf(id));
    }
    ...
    public static String selectFrenchMaleName() {
        return selectRow("SELECT * FROM " + TABLE_FRENCH_MALE_NAMES + " ORDER BY RANDOM() LIMIT 1", 2);
    }
    ...
    public static String selectHispanicCompoundSurname() {
        return selectRow("SELECT * FROM " + TABLE_SPANISH_COMPOUND_SURNAMES + " ORDER BY RANDOM() LIMIT 1", 2);
    }

    public static String selectHispanicCompoundSurname(int id) {
        return selectRow("SELECT * FROM " + TABLE_SPANISH_COMPOUND_SURNAMES + " WHERE " + TABLE_SPANISH_COMPOUND_SURNAMES + ID_PREFIX + " = ?", 2, String.valueOf(id));
    }
    ...
    public static String selectHispanicFemaleName() {
        return selectRow("SELECT * FROM " + TABLE_SPANISH_FEMALE_NAMES + " ORDER BY RANDOM() LIMIT 1", 2);
    }

    public static String selectHispanicFemaleName(int id) {
        return selectRow("SELECT * FROM " + TABLE_SPANISH_FEMALE_NAMES + " WHERE " + TABLE_SPANISH_FEMALE_NAMES + ID_PREFIX + " = ?", 2, String.valueOf(id));
    }
    ...
    public static String selectHispanicMaleName() {
        return selectRow("SELECT * FROM " + TABLE_SPANISH_MALE_NAMES + " ORDER BY RANDOM() LIMIT 1", 2);
    }

    public static String selectHispanicMaleName(int id) {
        return selectRow("SELECT * FROM " + TABLE_SPANISH_MALE_NAMES + " WHERE " + TABLE_SPANISH_MALE_NAMES + ID_PREFIX + " = ?", 2, String.valueOf(id));
    }
    ...
    public static String selectSpanishNoun() {
        return selectRow("SELECT * FROM " + TABLE_SPANISH_NOUNS + " ORDER BY RANDOM() LIMIT 1", 2);
    }

    public static String selectSpanishNoun(int id) {
        return selectRow("SELECT * FROM " + TABLE_SPANISH_NOUNS + " WHERE " + TABLE_SPANISH_NOUNS + ID_PREFIX + " = ?", 2, String.valueOf(id));
    }
    ...
    public static String selectSpanishOccupation() {
        return selectRow("SELECT * FROM " + TABLE_SPANISH_OCCUPATIONS + " ORDER BY RANDOM() LIMIT 1", 2);
    }

    public static String selectSpanishOccupation(int id) {
        return selectRow("SELECT * FROM " + TABLE_SPANISH_OCCUPATIONS + " WHERE " + TABLE_SPANISH_OCCUPATIONS + ID_PREFIX + " = ?", 2, String.valueOf(id));
    }
    ...
    public static String selectSpanishPluralAdjective() {
        return selectRow("SELECT * FROM " + TABLE_SPANISH_PLURAL_ADJECTIVES + " ORDER BY RANDOM() LIMIT 1", 2);
    }

    public static String selectSpanishPluralAdjective(int id) {
        return selectRow("SELECT * FROM " + TABLE_SPANISH_PLURAL_ADJECTIVES + " WHERE " + TABLE_SPANISH_PLURAL_ADJECTIVES + ID_PREFIX + " = ?", 2, String.valueOf(id));
    }
    ...
    public static String selectSpanishSingularAdjective() {
        return selectRow("SELECT * FROM " + TABLE_SPANISH_SINGULAR_ADJECTIVES + " ORDER BY RANDOM() LIMIT 1", 2);
    }

    public static String selectSpanishSingularAdjective(int id) {
        return selectRow("SELECT * FROM " + TABLE_SPANISH_SINGULAR_ADJECTIVES + " WHERE " + TABLE_SPANISH_SINGULAR_ADJECTIVES + ID_PREFIX + " = ?", 2, String.valueOf(id));
    }
    ...
    public static String selectHispanicSurname() {
        return selectRow("SELECT * FROM " + TABLE_SPANISH_SURNAMES + " ORDER BY RANDOM() LIMIT 1", 2);
    }
    ...
    public static String selectFamilyName() {
        return selectRow("SELECT * FROM " + TABLE_FAMILY_NAMES + " ORDER BY RANDOM() LIMIT 1", 2);
    }

    public static String selectFamilyName(int id) {
        return selectRow("SELECT * FROM " + TABLE_FAMILY_NAMES + " WHERE " + TABLE_FAMILY_NAMES + ID_PREFIX + " = ?", 2, String.valueOf(id));
    }
    ...
    public static String selectFemaleName() {
        return selectRow("SELECT * FROM " + TABLE_FEMALE_NAMES + " ORDER BY RANDOM() LIMIT 1", 2);
    }

    public static String selectFemaleName(int id) {
        return selectRow("SELECT * FROM " + TABLE_FEMALE_NAMES + " WHERE " + TABLE_FEMALE_NAMES + ID_PREFIX + " = ?", 2, String.valueOf(id));
    }
    ...
    public static String selectMaleName() {
        return selectRow("SELECT * FROM " + TABLE_MALE_NAMES + " ORDER BY RANDOM() LIMIT 1", 2);
    }

    public static String selectMaleName(int id) {
        return selectRow("SELECT * FROM " + TABLE_MALE_NAMES + " WHERE " + TABLE_MALE_NAMES + ID_PREFIX + " = ?", 2, String.valueOf(id));
    }
    ...
    public static String selectName() {
        return selectRow("SELECT * FROM " + TABLE_NAMES + " ORDER BY RANDOM() LIMIT 1", 2);
    }

    public static String selectName(int id) {
        return selectRow("SELECT * FROM " + TABLE_NAMES + " WHERE " + TABLE_NAMES + ID_PREFIX + " = ?", 2, String.valueOf(id));
    }
    ...
    public static String selectCommonNoun() {
        return selectRow("SELECT * FROM " + TABLE_NOUNS + " ORDER BY RANDOM() LIMIT 1", 2);
    }

    public static String selectCommonNoun(int id) {
        return selectRow("SELECT * FROM " + TABLE_NOUNS + " WHERE " + TABLE_NOUNS + ID_PREFIX + " = ?", 2, String.valueOf(id));
    }
    ...
    public static String selectUsername() {
        return selectRow("SELECT * FROM " + TABLE_USERNAMES + " ORDER BY RANDOM() LIMIT 1", 2);
    }

    public static String selectUsername(int id) {
        return selectRow("SELECT * FROM " + TABLE_USERNAMES + " WHERE " + TABLE_USERNAMES + ID_PREFIX + " = ?", 2, String.valueOf(id));
    }
}
