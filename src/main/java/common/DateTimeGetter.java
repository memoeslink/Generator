...
public class DateTimeGetter {
    ...
    public static String getCurrentDateTime(int type) {
        ...
        return switch (type) {
            case 1 -> ZonedDateTime.now().format(DateTimeFormatter.ISO_LOCAL_DATE_TIME.withLocale(locale));
            case 2 -> ZonedDateTime.now().format(DateTimeFormatter.ISO_DATE_TIME.withLocale(locale));
            case 3 ->
    ...
    public static String getCurrentDate(int type) {
        ...
        return switch (type) {
            ...
            case 9 -> LocalDateTime.now().format(DateTimeFormatter.ISO_LOCAL_DATE.withLocale(locale));
    ...
    public static String getCurrentTime(int type) {
        ...
        return switch (type) {
            ...
            case 6 -> ZonedDateTime.now().format(DateTimeFormatter.ISO_LOCAL_TIME.withLocale(locale));
