...
public class TextProcessor {
    ...
    public static String feminize(String s, String ending) {
        ...
        if (StringHelper.endsWithAny(s, base.Constant.VOWELS.toCharArray()))
    ...
    public static String genderify(String s, Gender gender, WordCombination combination) {
        ...
        while (matcher.find()) {
            switch (gender) {
                ...
                case NEUTRAL -> matcher.appendReplacement(sb, getFirstSeveredWord(matcher.group(0)).getNeutralForm());
                default -> {
    ...
    public static TextComponent genderifyStr(String s, Gender gender) {
        ...
        component.setText(s);
        Matcher matcher = EXTENDED_TEXT_PATTERN.matcher(s);
        StringBuilder sb = new StringBuilder();
