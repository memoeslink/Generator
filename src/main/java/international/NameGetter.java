...
public class NameGetter extends base.NameGetter {
    ...
    public String getFemaleFullName() {
        return switch (r.getInt(3)) {
            ...
            default -> getAnyGetter(new Exception().getStackTrace()[0].getMethodName()).getFemaleFullName();
        };
    }
    ...
    public String getMaleFullName() {
        return switch (r.getInt(3)) {
            ...
            case 2 ->
                    Database.selectMaleName(r.getIntInRange(1, Database.countMaleNames())) + Separator.SPACE.getCharacter() +
                            Database.selectSurname(r.getIntInRange(1, Database.countSurnames()));
            default -> getAnyGetter(new Exception().getStackTrace()[0].getMethodName()).getMaleFullName();
        };
    }
