...
public class Constant {
    ...
    public static final WeightedChar[] SPANISH_WEIGHTED_LETTERS = {
            new WeightedChar('e', 0.00137D),
            new WeightedChar('a', 0.00117D),
            new WeightedChar('o', 0.00084D),
            new WeightedChar('s', 0.00072D),
            new WeightedChar('n', 0.00068D),
            new WeightedChar('r', 0.00064D),
            new WeightedChar('i', 0.00053D),
            new WeightedChar('l', 0.00052D),
            new WeightedChar('d', 0.00047D),
            new WeightedChar('t', 0.00046D),
            new WeightedChar('u', 0.00046D),
            new WeightedChar('c', 0.00039D),
            new WeightedChar('m', 0.00031D),
            new WeightedChar('p', 0.00029D),
            new WeightedChar('b', 0.00015D),
            new WeightedChar('h', 0.00012D),
            new WeightedChar('q', 0.00011D),
            new WeightedChar('y', 0.00011D),
            new WeightedChar('v', 0.00011D),
            new WeightedChar('g', 0.0001D),
            //new WeightedChar('ó', 0.00008D),
            //new WeightedChar('í', 0.00007D),
            new WeightedChar('f', 0.00007D),
            new WeightedChar('j', 0.00005D),
            new WeightedChar('z', 0.00005D),
            //new WeightedChar('á', 0.00004D),
            //new WeightedChar('é', 0.00004D),
            new WeightedChar('ñ', 0.00002D),
            new WeightedChar('x', 0.00001D),
            //new WeightedChar('ú', 0.00001D),
            new WeightedChar('k', 0.00001D),
            new WeightedChar('w', 0.000004D),
            //new WeightedChar('ü', 0.000002D)
    };
    ...
    public static final String[] ANY_CONSONANT_PAIRS = {"bl", "br", "by", "ch", "cl", "cr", "cy", "dr", "dw", "fl", "fn", "fr", "fy", "gh", "gl", "gn", "gr", "gw", "gy", "hl", "hw", "hy", "kn", "kr", "ky", "ly", "ny", "ph", "pr", "ps", "py", "rh", "ry", "sc", "my", "sh", "sk", "sl", "sm", "sn", "sp", "sq", "st", "sw", "sy", "pl", "tp", "tr", "tw", "ty", "vy", "wh", "wl", "th", "vl", "wr", "wy", "yb", "yc", "yd", "yf", "yh", "yl", "ym", "yn", "yp", "yr", "ys", "yt", "yv", "yw"};
